	...
	<?php  } ?>
		...
		avatarload = function() {
			 ...
			 $.ajax({
			            ...
			            async: 'false',
			            beforeSend: function () {
			              $(content_selector).html('<?php echo $language->get('text_sc_loading'); ?>...<img src="catalog/view/theme/default/image/aloading16.png" alt="loading" class="loading" style="padding-left: 5px;" />');
			            },
