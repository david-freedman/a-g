...
<?php
if (SC_VERSION < 20) {
		$document->addStyle('catalog/view/javascript/blog/owl-carousel/owl.carousel.css');
		$document->addScript('catalog/view/javascript/blog/owl-carousel/owl.carousel.min.js');
}
?>
