	  ...
	  <div class="input-group"><select class="form-control" name="ascp_settings[reviews_widget_status]">
	      ...
	      <?php } ?>
				   ...
				   <table id="comment_types" class="list">
				    ...
				    <tr>
				     <td class="left"><?php echo $entry_wysibbuploader_posturl; ?></td>
				     <td class="left">
				      <div class="input-group" style="width: 100%;">
				      <input type="text" class="form-control" name="ascp_settings[wysibbuploader_posturl]" value="<?php  if (isset($ascp_settings['wysibbuploader_posturl'])) echo $ascp_settings['wysibbuploader_posturl']; ?>" />
				      </div>
				     </td>
				    </tr>
				    ...
				    <tr>
				     <td class="left"><?php echo $entry_wysibbuploader_key_imageshack; ?></td>
				     <td class="left">
				      <div class="input-group">
				      <input type="password" class="form-control" name="ascp_settings[wysibbuploader_key_imageshack]" value="<?php  if (isset($ascp_settings['wysibbuploader_key_imageshack'])) echo $ascp_settings['wysibbuploader_key_imageshack']; ?>" size="60" />
				      </div>
				     </td>
				    </tr>

				    <tr>
				     <td class="left"><?php echo $entry_wysibbuploader_maxwidth; ?></td>
				     <td class="left">
				      <div class="input-group">
				      <input type="text" class="form-control" name="ascp_settings[wysibbuploader_maxwidth]" value="<?php  if (isset($ascp_settings['wysibbuploader_maxwidth'])) echo $ascp_settings['wysibbuploader_maxwidth']; ?>" size="3" />
				      </div>
				     </td>
				    </tr>

				    <tr>
				     <td class="left"><?php echo $entry_wysibbuploader_maxheight; ?></td>
				     <td class="left">
				      <div class="input-group">
				      <input type="text" class="form-control" name="ascp_settings[wysibbuploader_maxheight]" value="<?php  if (isset($ascp_settings['wysibbuploader_maxheight'])) echo $ascp_settings['wysibbuploader_maxheight']; ?>" size="3" />
				      </div>
				     </td>
				    </tr>
...
var comment_type_row = <?php echo $comment_type_row++; ?>;
