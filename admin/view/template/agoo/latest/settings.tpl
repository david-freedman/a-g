	      ...
	      <?php } ?>
                         ...
                         <!--
				          ...
				          <tr>
				              ...
				              <td>
				              	<div>
                                	<?php echo $language->get('text_cache_pages_link'); ?>
				                </div>
				                </td>
				            </tr>
				    ...
				    <tr class="pro">
				     ...
				     <div class="input-group">
				      <input class="form-control" type="text" name="ascp_settings[blog_num_desc_pred]" value="<?php  if (isset($ascp_settings['blog_num_desc_pred'])) echo $ascp_settings['blog_num_desc_pred']; ?>" size="3" />
				         ...
				         <tr class="pro">
				              <td><?php echo $language->get('entry_admin_visualeditor_status'); ?></td>
				              <td>
				              <div class="input-group">
				              <select class="form-control" name="ascp_settings[admin_visualeditor_status]">
				                  <?php if (isset($ascp_settings['admin_visualeditor_status']) && $ascp_settings['admin_visualeditor_status']) { ?>
				                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
				                  <option value="0"><?php echo $text_disabled; ?></option>
				                  <?php } else { ?>
				                  <option value="1" <?php if (!isset($ascp_settings['admin_visualeditor_status'])) { ?> selected="selected" <?php } ?> ><?php echo $text_enabled; ?></option>
				                  <option value="0" <?php if (isset($ascp_settings['admin_visualeditor_status'])) { ?> selected="selected" <?php } ?> ><?php echo $text_disabled; ?></option>
				                  <?php } ?>
				                </select>
				                </div>
				                </td>
				     ...
				     <td class="left">
				      <div class="input-group">
				          ...
				          <tr class="pro">
				              ...
				              <td>
				              <div class="input-group">
				              <select class="form-control" name="ascp_settings[comp_url]">
				                  <?php if (isset($ascp_settings['comp_url']) && $ascp_settings['comp_url']) { ?>
				                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
				                  <option value="0"><?php echo $text_disabled; ?></option>
				                  <?php } else { ?>
				                  <option value="1"><?php echo $text_enabled; ?></option>
				          ...
				          <tr class="pro">
				              <td><?php echo $language->get('entry_url_secure'); ?></td>
				              <td>
				              <div class="input-group">
				              <select class="form-control" name="ascp_settings[seocms_url_secure]">

								<?php foreach ($url_secure as $value => $name) { ?>
					              	<option value="<?php echo $value; ?>" <?php if (isset($ascp_settings['seocms_url_secure']) && $ascp_settings['seocms_url_secure'] == $value) { ?> selected="selected" <?php } ?>><?php echo $name; ?></option>
					            <?php } ?>
