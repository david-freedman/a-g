		...
		<div id="tab-options-<?php echo $list_num;?>" class="tabs_in_widgets">
			<table>
				...
				<tr>
					...
					<textarea cols="50" rows="1" class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][upload_allowed]"><?php  if (isset($list['upload_allowed'])) echo $list['upload_allowed']; else echo $language->get('text_upload_allowed');  ?></textarea>
					</div>
					</td>
				...
				<tr>
					...
					<td class="left">
						<div class="input-group"><span class="input-group-addon"></span>
						<textarea cols="50" rows="3" class="form-control"  id="ascp_widgets_<?php echo $list_num; ?>_anchor" name="ascp_widgets[<?php echo $list_num; ?>][anchor]"><?php  if (isset($list['anchor'])) echo $list['anchor']; ?></textarea>
						</div>
				...
				<tr>
					...
					<td>
						<div class="input-group"><select class="form-control" name="ascp_widgets[<?php echo $list_num; ?>][cached]">
